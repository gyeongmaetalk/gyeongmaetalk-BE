...
public class ReviewController {
    ...
    public BaseResponse<ReviewIdResponse> createReview(
            ...
            @Parameter(description = "상담 후기 생성 요청 json")  @Valid @RequestBody ReviewCreateRequest request
            ){
        return BaseResponse.onSuccess(reviewService.createReview(request, principal.getMember()));
    }
    ...
    public BaseResponse<ReviewIdResponse> updateReview(
            ...
            @Parameter(description = "상담 후기 수정 요청 json")  @Valid @RequestBody ReviewUpdateRequest request
    ){
        return BaseResponse.onSuccess(reviewService.updateReview(reviewId, request, member.getMember().getId()));
    }
